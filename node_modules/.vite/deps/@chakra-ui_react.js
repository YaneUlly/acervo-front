...
function getValidChildren(children) {
  return import_react69.Children.toArray(children).filter(
    (child) => (0, import_react69.isValidElement)(child)
  );
}
...
var AvatarGroup = forwardRef(
  function AvatarGroup2(props, ref) {
    ...
    const clones = reversedChildren.map((child, index2) => {
      ...
      return (0, import_react70.cloneElement)(child, compact2(childProps));
    });
    const groupStyles = {
      display: "flex",
      alignItems: "center",
  ...
  function BreadcrumbItem2(props, ref) {
    ...
    const clones = validChildren.map((child) => {
      if (child.type === BreadcrumbLink) {
        return (0, import_react71.cloneElement)(child, {
          isCurrentPage
        });
      }
...
var Breadcrumb = forwardRef(
  function Breadcrumb2(props, ref) {
    ...
    const clones = validChildren.map(
      (child, index2) => (0, import_react72.cloneElement)(child, {
        separator,
        spacing,
...
function useButtonType(value) {
  const [isButton, setIsButton] = (0, import_react74.useState)(!value);
  const refCallback = (0, import_react74.useCallback)((node2) => {
    if (!node2)
      return;
...
function ButtonIcon(props) {
  ...
  const _children = (0, import_react75.isValidElement)(children) ? (0, import_react75.cloneElement)(children, {
    "aria-hidden": true,
    focusable: false
  }) : children;
...
function ButtonSpinner(props) {
  ...
  const spinnerStyles = (0, import_react76.useMemo)(
    () => ({
      display: "flex",
      alignItems: "center",
...
var Button = forwardRef((props, ref) => {
  ...
  const buttonStyles = (0, import_react77.useMemo)(() => {
...
var IconButton = forwardRef(
  (props, ref) => {
    ...
    const _children = (0, import_react78.isValidElement)(element) ? (0, import_react78.cloneElement)(element, {
      "aria-hidden": true,
      focusable: false
    }) : null;
...
function useCheckboxGroup(props = {}) {
  ...
  const getCheckboxProps = (0, import_react79.useCallback)(
    (props2 = {}) => {
...
function useInitialAnimationState(isChecked) {
  const [previousIsChecked, setPreviousIsChecked] = (0, import_react81.useState)(isChecked);
  const [shouldAnimate, setShouldAnimate] = (0, import_react81.useState)(false);
...
function useFormControlProvider(props) {
  ...
  const [isFocused, setFocus] = (0, import_react82.useState)(false);
...
function useCheckbox(props = {}) {
  ...
  const getIndicatorProps = (0, import_react83.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      ...props2,
      ref: forwardedRef,
      "data-active": dataAttr(isActive),
...
var focusScope = (0, import_react91.createContext)(void 0);
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react123.useMemo)(
    () => shouldWrapChildren ? import_react123.Children.map(children, (child, index2) => (0, import_jsx_runtime71.jsx)(WrapItem, { children: child }, index2)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const clones = (0, import_react124.useMemo)(() => {
    ...
    return shouldUseChildren ? validChildren : validChildren.map((child, index2) => {
      ...
      return (0, import_jsx_runtime74.jsxs)(import_react124.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function useHighlight(props) {
  ...
  return (0, import_react125.useMemo)(() => highlightWords({ text, query }), [text, query]);
}
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime80.jsx)(import_jsx_runtime80.Fragment, { children: chunks.map((chunk, index2) => {
    return chunk.match ? (0, import_jsx_runtime80.jsx)(Mark, { sx: styles, children: chunk.text }, index2) : (0, import_jsx_runtime80.jsx)(import_react125.Fragment, { children: chunk.text }, index2);
  }) });
}
...
function usePinInput(props = {}) {
  ...
  const [moveFocus2, setMoveFocus] = (0, import_react152.useState)(true);
...
var SelectIcon = (props) => {
  ...
  return (0, import_jsx_runtime135.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react160.isValidElement)(children) ? clone : null });
};
